...
inline auto ParametricMeshExamples()
{
    return [](World& World)
    {
        ...
        auto Surface = World.SpawnActor<ParametricMeshActor>("Bunny_SCAF", StaticMesh::LoadObj(Path("openbunny.obj"))->Normalized(), BoxBorderConformal);
    	...
    	auto Spot = World.SpawnActor<ParametricMeshActor>("Spot_SphereicalConformal", StaticMesh::LoadObj(Path("spot.obj"))->Normalized(), SphereicalConformal);
