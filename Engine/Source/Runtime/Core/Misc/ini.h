...
class INIReader {
   public:
	...
	bool ContainSection(const std::string& section) const;
	bool ContainKey(const std::string& section, const std::string& key) const;
...
inline bool INIReader::ContainSection(const std::string& section) const
{
	return _values.find(section) != _values.end();
}
inline bool INIReader::ContainKey(const std::string& section, const std::string& key) const
{
	return _values.find(section) != _values.end() && _values.at(section).find(key) != _values.at(section).end();
}
