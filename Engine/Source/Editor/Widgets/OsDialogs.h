...
using SaveFileDialog = pfd::save_file;
using OpenFileDialog = pfd::open_file;
using SelectFolderDialog = pfd::select_folder;
using MessageBoxDialog = pfd::message;
using NotifyDialog = pfd::notify;

const std::vector<std::string> TextFilesFilter = { "Text Files (.txt .text)", "*.txt *.text" };
const std::vector<std::string> AllFilesFilter = { "All Files", "*" };
const std::vector<std::string> ObjFilesFilter = { "Object Files (.obj)", "*.obj" };